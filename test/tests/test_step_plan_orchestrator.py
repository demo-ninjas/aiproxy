...
def run(streamer:StreamWriter):
    ...
    config['preamble'] = """You are a personal assistant for families. You can save notes for the family, chat with the AI, chat with other AI assistants, and search for recipes that the family might be interested in.
    ...
    * If the user asks for the result of a maths forumla/equation, you can use the 'calculate' function to calculate the result
    """
